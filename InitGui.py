...
class BaptWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        import BaptCommands
        self.list = ["Bapt_CreateCamProject", "Bapt_Command", "Bapt_CreateDrillGeometry", "Bapt_CreateContourGeometry", "Bapt_CreateMachiningCycle", "Bapt_CreateHotReload"]  # Ajout de la nouvelle commande
