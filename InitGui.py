...
class BaptWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        import BaptCommands
        self.list = ["Bapt_CreateCamProject", "Bapt_Command", "Bapt_CreateDrillGeometry", "Bapt_ToolsManager", "Bapt_CreateHotReload"]  # Ajout de la commande du gestionnaire d'outils
