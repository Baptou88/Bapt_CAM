...
class BaptWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        import BaptCommands
        import BaptTools
        self.list = ["Bapt_CreateCamProject", "Bapt_Command", "Bapt_CreateDrillGeometry", "Bapt_CreateDrillOperation", "Bapt_ToolsManager", "Bapt_CreateHotReload"]  # Ajout de la commande d'opération de perçage
